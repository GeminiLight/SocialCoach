...
- 空间 Git：`https://modelscope.cn/studios/GeminiLight/SocialCoach.git`，分支 `master`，当前部署提交 `beb8a04`（2026-09-10，含匿名使用统计两批、稿纸封面与引导页插画，对应 GitHub main `9883067`）。通过独立克隆同步应用必需文件，未将本地 Git 历史、环境变量或其他文档上传。
