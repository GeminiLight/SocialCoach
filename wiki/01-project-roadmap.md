...
| B12 | 匿名使用统计 → 飞书（四个事件、按月建表、留存脚本） | ✅ | 2026-09-10 Vercel 生产上线并跑通一局无错误；ModelScope 代码已推送，待网页加 Secret `ANALYTICS_FEISHU_TABLE_PREFIX` 并重启空间 → [spec-analytics](./specs/spec-analytics.md) |
