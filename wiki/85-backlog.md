...
- [x] 2026-09-21 核心路径 UI/UX 精修：练习进程、紧凑目录与状态保留、草稿恢复、历史阅读保护、复盘章节导航、真实等待文案及辅助阅读语义。含本地浏览器回归脚本，未部署 → [评审](./archive/reviews/review-2026-09-21-product-ux.md)。
...
实现、验证与边界见 [通用策略方案](./specs/spec-general-practice-policy.md)。
